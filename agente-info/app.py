"""
app.py
Autenticação nativa Streamlit via Google OIDC (st.login / st.user) -- mesmo
padrão de financeiro/ e visao-clientes/ (ver Dashboard_Agente_Informacao.md,
seção "Estrutura da aplicação").
"""
import streamlit as st
from utils.style import inject_css

st.set_page_config(
    page_title="Agente de Informação | InChurch",
    page_icon="🤖",
    layout="wide",
        ...
        st.markdown(
            ...
            <div style="text-align:center; padding: 60px 0 32px 0;">
              ...
              <p style="color:#a0a0a0; font-size:1rem; margin-top:0;">
                Agente de Informação — Pergunte sobre os dados da InChurch
              </p>
            </div>
            """,
...
st.switch_page("pages/1_Assistente.py")
